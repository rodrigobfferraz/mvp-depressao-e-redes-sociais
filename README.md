...
│   └── yrbs2023.csv                       ← Microdados YRBS 2023 (convertido de MDB)
│
├── outputs/
...
git clone https://github.com/rodrigobfferraz/mvp-depressao-e-redes-sociais.git
cd mvp-depressao-e-redes-sociais
...
**Parte B — Intra-survey (YRBS 2023):** Análise de dados individuais do YRBS 2023, que pela primeira vez incluiu pergunta sobre frequência de uso de redes sociais (Q87/QN87). Tabelas cruzadas, qui-quadrado, razão de prevalência e odds ratio. Esta análise mitiga a falácia ecológica da Parte A.
...
*MVP desenvolvido como parte de pós-graduação.*
